...
Future<void> loadKaTeXFonts() async {
  ...
  final katexMainLoader =
      FontLoader('packages/flutter_math_fork/KaTeX_Main')
        ...
        ..addFont(
          getFontData('lib/katex_fonts/fonts/KaTeX_Main-BoldItalic.ttf'),
        );

  final katexMathLoader =
      FontLoader('packages/flutter_math_fork/KaTeX_Math')
        ..addFont(getFontData('lib/katex_fonts/fonts/KaTeX_Math-Italic.ttf'))
        ..addFont(
          getFontData('lib/katex_fonts/fonts/KaTeX_Math-BoldItalic.ttf'),
        );
  ...
  final katexCaligraphicLoader =
      FontLoader('packages/flutter_math_fork/KaTeX_Caligraphic')
        ..addFont(
          getFontData('lib/katex_fonts/fonts/KaTeX_Caligraphic-Regular.ttf'),
        )
        ..addFont(
          getFontData('lib/katex_fonts/fonts/KaTeX_Caligraphic-Bold.ttf'),
        );

  final katexFrakturLoader =
      FontLoader('packages/flutter_math_fork/KaTeX_Fraktur')
        ..addFont(
          getFontData('lib/katex_fonts/fonts/KaTeX_Fraktur-Regular.ttf'),
        )
        ..addFont(getFontData('lib/katex_fonts/fonts/KaTeX_Fraktur-Bold.ttf'));

  final katexSansSerifLoader =
      FontLoader('packages/flutter_math_fork/KaTeX_SansSerif')
        ..addFont(
          getFontData('lib/katex_fonts/fonts/KaTeX_SansSerif-Regular.ttf'),
        )
        ..addFont(getFontData('lib/katex_fonts/fonts/KaTeX_SansSerif-Bold.ttf'))
        ..addFont(
          getFontData('lib/katex_fonts/fonts/KaTeX_SansSerif-Italic.ttf'),
        );
  ...
  final katexTypewriterLoader = FontLoader(
  ...
  final excalifontLoader = FontLoader(
    'packages/flutter_math_fork/KaTeX_Excalifont',
  )..addFont(getFontData('lib/katex_fonts/fonts/KaTeX_Excalifont-Regular.ttf'));
  ...
  await Future.wait([
    ...
    excalifontLoader.load(),
  ]);
}

Future<ByteData> getFontData(String name) => File(name).readAsBytes().then(
